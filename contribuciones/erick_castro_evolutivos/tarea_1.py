...
def evaluar_fitness(individuo):
    ...
    Suma el valor de los objetos seleccionados.
    Si el peso total supera CAPACIDAD_MAXIMA, retorna 0 (penalización extrema).
    """
    peso_total = 0
    valor_total = 0
...
def seleccion_torneo(poblacion, fitnesses, k=3):
    """
    Selecciona un individuo mediante el método de torneo.
    Se eligen 'k' individuos al azar y se selecciona el de mejor fitness.
    """
...
def mutacion(individuo):
    """
    Aplica mutación bit a bit según TASA_MUTACION.
    Cada gen se invierte con probabilidad igual a la tasa de mutación.
    """
