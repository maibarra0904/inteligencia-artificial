...
def crear_individuo():
    ...
    """
    # TODO: Retorna una lista de longitud len(OBJETOS) con valores 0 o 1 generados aleatoriamente
...
def crear_poblacion(tamano):
    ...
    """
    # TODO: Retorna una lista con 'tamaño' cantidad de individuos creados
...
def evaluar_fitness(individuo):
    ...
    # TODO: Calcula el peso_total y el valor_total recorriendo el individuo e indexando en la lista de OBJETOS.
    for i, gen in enumerate(individuo):
        if gen == 1:
            peso_total += OBJETOS[i][1]
            valor_total += OBJETOS[i][2]
            
    # TODO: Si peso_total supera CAPACIDAD_MAXIMA, penaliza la aptitud retornando 0 o 1.
    # En caso contrario, retorna el valor_total como aptitud.
...
def seleccion_torneo(poblacion, fitnesses, k=3):
    ...
    """
    # TODO: Elije k índices aleatorios de la población
    seleccionados = random.sample(range(len(poblacion)), k)
    
    # TODO: Identifica cuál de los individuos seleccionados tiene la mayor aptitud
...
def cruzamiento(padre1, padre2):
    ...
    if random.random() < TASA_CRUZAMIENTO:
        # TODO: Selecciona un punto de corte aleatorio entre 1 y len(OBJETOS) - 1
        punto = random.randint(1, len(OBJETOS) - 1)
        
        # TODO: Crea los hijos combinando las partes de los padres en el punto de corte
...
def mutacion(individuo):
    ...
    for i in range(len(mutado)):
        if random.random() < TASA_MUTACION:
            # TODO: Invierte el gen (si es 0 pasa a 1, si es 1 pasa a 0)
            mutado[i] = 1 - mutado[i]
    return mutado
...
def ejecutar_algoritmo_genetico():
    ...
    for gen in range(GENERACIONES):
        ...
        # TODO: Implementa el ciclo para llenar la nueva población.
        # En cada iteración, selecciona dos padres usando seleccion_torneo,
        # se cruzan usando cruzamiento, aplica mutacion a cada hijo y se agrega a nueva_poblacion.
...
if __name__ == "__main__":
    # Asegura reproducibilidad para comparar
    random.seed(42)
